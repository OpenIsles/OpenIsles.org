...
{block "additionalMetaTags"}
	{capture attr}
		<translate lang="de">
		Willkommen auf OpenIsles! OpenIsles ist ein freies Insel-Aufbauspiel, was sich maßgeblich an dem Klassiker Anno&nbsp;1602 orientiert.
		</translate>
		<translate lang="en">
		Welcome to OpenIsles! OpenIsles is a free island-building game which significantly orientates itself by the classic Anno&nbsp;1602.
		</translate>
	{/capture}
