...
CREATE TABLE screenshot (
    order_index INT NOT NULL COMMENT 'fortlaufender Zähler für die Sortierreihenfolge',
...
CREATE TABLE video (
    order_index INT NOT NULL COMMENT 'fortlaufender Zähler für die Sortierreihenfolge',
    file_prefix VARCHAR(64) NOT NULL COMMENT 'Dateinamen-Präfix des Videos',
    description_de VARCHAR(512) NOT NULL COMMENT 'Beschreibung (deutsch)',
    description_en VARCHAR(512) NOT NULL COMMENT 'Beschreibung (englisch)',
    created_date DATE NOT NULL COMMENT 'Datum, wann das Video angelegt wurde',
    PRIMARY KEY (file_prefix),
    UNIQUE (order_index)
);

INSERT INTO video (order_index, file_prefix, description_de, description_en, created_date) VALUES
    (
        2,
        '2015-05-17-growth',
        'Zeigt den Wachstumsalgorithmus. Es werden Wälder und Felder gebaut und dann kann man zugucken, wie alles wächst.',
        'Shows the growing algorithm. Forest and fields are built and one can watch them growing.',
        '2015-05-17'
    ), (
        1,
        '2014-10-14-carrier-animation',
        'Sehr früher Entwicklungsstand, wie sich zum ersten Mal was bewegt. Im Video sind die ersten Schritte eines Trägers zu sehen.',
